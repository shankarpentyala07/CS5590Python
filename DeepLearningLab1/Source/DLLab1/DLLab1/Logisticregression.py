...
dataset = '/home/shankarpentyala/Downloads/DeepLearning_Lesson2_SourceCode/kc_weather_srt.csv'
...
try:
    for i in range(1500):
        ...
        if (i + 1) % 300 == 0:
            print(' Loss for every 300 iterations = ' + str(temp_loss))
...
plt.plot(train_acc, 'g', label='Training Set Accuracy')
